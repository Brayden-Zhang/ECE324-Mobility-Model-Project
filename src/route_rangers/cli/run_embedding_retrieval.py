...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Embedding retrieval evaluation (kNN) for trajectory models."
    )
    ...
    # Default name matches collect_results.py glob: cache/embedding_retrieval_*.json
    parser.add_argument(
        "--output", type=str, default="cache/embedding_retrieval_latest.json"
    )
