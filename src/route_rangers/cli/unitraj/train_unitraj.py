...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train the bundled UniTraj-compatible baseline on a local WorldTrace-format dataset"
    )
    parser.add_argument("--data_path", type=str, required=True)
    parser.add_argument("--output_dir", type=str, default="checkpoints/unitraj")
