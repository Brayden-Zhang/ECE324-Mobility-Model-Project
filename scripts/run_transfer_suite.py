...
def parse_args():
    parser = argparse.ArgumentParser(description="Run UniTraj-style eval across multiple datasets")
    ...
    parser.add_argument("--output", type=str, default="cache/unitraj_transfer_suite.json")
